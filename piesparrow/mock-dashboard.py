...
ps.init(filename='mock-dashboard-light', title='Mock Dashboard - pieSparrow', basetheme=ps.loclight, charttheme=ps.locrainbowl)
...
ps.row(
        ps.colmd(ps.h2('This is Line Chart')+ps.chart(type='line', df=df, title='line', columns=['Month','Data 1','Data 2', 'Data 3', 'Data 4', 'Data 5'], xcolumn='Month', height=350), type='card',align='left')+
        ps.colmd(ps.h2('This is Donut Chart')+ps.donut(title='donut', df=df, columns=['Data 1','Data 2', 'Data 3', 'Data 4', 'Data 5'], height=350), type='card',align='left')
)

ps.row(
        ps.colmd(ps.h2('This is Pie Chart')+ps.pie(df=df, title='pie', columns=['Data 1','Data 2', 'Data 3', 'Data 4', 'Data 5'],  height=350), type='card',align='left')+
        ps.colmd(ps.h2('This is Area Chart')+ps.chart(type='area',title='area', df=df, columns=['Month','Data 1','Data 2', 'Data 3', 'Data 4', 'Data 5'], xcolumn='Month',height=350), type='card',align='left')
)

ps.row(
        ps.colmd(ps.h2('This is Spline Chart')+ps.chart(type='spline', df=df, title='spline', columns=['Month','Data 1','Data 2', 'Data 3', 'Data 4', 'Data 5'], xcolumn='Month', height=400), type='card',align='left')+
